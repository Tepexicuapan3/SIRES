...
interface BuildPasesTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: PaseListItem) => void;
  onToggleStatus: (item: PaseListItem) => void;
  onRequestDelete: (item: PaseListItem) => void;
}

export const buildPasesTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildPasesTableColumnsOptions): DataTableColumn<PaseListItem>[] => {
  const baseColumns: DataTableColumn<PaseListItem>[] = [
    {
      key: "name",
      header: "Pase",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<PaseListItem> = {
    key: "actions",
...
export const buildPasesVisibilityOptions = (
  showActions: boolean,
