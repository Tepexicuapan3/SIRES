...
interface BuildBajasTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: BajaListItem) => void;
  onToggleStatus: (item: BajaListItem) => void;
  onRequestDelete: (item: BajaListItem) => void;
}

export const buildBajasTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildBajasTableColumnsOptions): DataTableColumn<BajaListItem>[] => {
  const baseColumns: DataTableColumn<BajaListItem>[] = [
    {
      key: "name",
      header: "Baja",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<BajaListItem> = {
    key: "actions",
...
export const buildBajasVisibilityOptions = (
  showActions: boolean,
