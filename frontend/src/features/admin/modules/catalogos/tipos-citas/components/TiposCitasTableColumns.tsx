...
interface BuildTiposCitasTableColumnsOptions {
  canReadTipoCita: boolean;
  canUpdateTipoCita: boolean;
  canDeleteTipoCita: boolean;
  isStatusPending: boolean;
  onOpenDetails: (tipoCita: TipoCitaListItem) => void;
  onToggleStatus: (tipoCita: TipoCitaListItem) => void;
  onRequestDelete: (tipoCita: TipoCitaListItem) => void;
}

export const buildTiposCitasTableColumns = ({
  canReadTipoCita,
  canUpdateTipoCita,
  canDeleteTipoCita,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildTiposCitasTableColumnsOptions): DataTableColumn<TipoCitaListItem>[] => {
  const baseColumns: DataTableColumn<TipoCitaListItem>[] = [
    {
      key: "name",
      header: "Tipo de cita",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<TipoCitaListItem> = {
    key: "actions",
...
export const buildTiposCitasVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Tipo de cita" },
