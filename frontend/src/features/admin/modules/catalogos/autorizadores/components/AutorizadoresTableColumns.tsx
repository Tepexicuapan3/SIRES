...
interface BuildAutorizadoresTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: AutorizadorListItem) => void;
  onToggleStatus: (item: AutorizadorListItem) => void;
  onRequestDelete: (item: AutorizadorListItem) => void;
}

export const buildAutorizadoresTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildAutorizadoresTableColumnsOptions): DataTableColumn<AutorizadorListItem>[] => {
  const baseColumns: DataTableColumn<AutorizadorListItem>[] = [
    {
      key: "name",
      header: "Autorizador",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<AutorizadorListItem> = {
    key: "actions",
...
export const buildAutorizadoresVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Autorizador" },
