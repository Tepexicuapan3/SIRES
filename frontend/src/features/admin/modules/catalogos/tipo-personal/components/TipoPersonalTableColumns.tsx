...
interface BuildTipoPersonalTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: TipoPersonalListItem) => void;
  onToggleStatus: (item: TipoPersonalListItem) => void;
  onRequestDelete: (item: TipoPersonalListItem) => void;
}

export const buildTipoPersonalTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildTipoPersonalTableColumnsOptions): DataTableColumn<TipoPersonalListItem>[] => {
  const baseColumns: DataTableColumn<TipoPersonalListItem>[] = [
    {
      key: "name",
  ...
  const actionColumn: DataTableColumn<TipoPersonalListItem> = {
    key: "actions",
...
export const buildTipoPersonalVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Tipo de personal" },
