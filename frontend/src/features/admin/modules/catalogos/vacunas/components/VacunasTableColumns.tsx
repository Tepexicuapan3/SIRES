...
interface BuildVacunasTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (vacuna: VacunaListItem) => void;
  onToggleStatus: (vacuna: VacunaListItem) => void;
  onRequestDelete: (vacuna: VacunaListItem) => void;
}

export const buildVacunasTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildVacunasTableColumnsOptions): DataTableColumn<VacunaListItem>[] => {
  const baseColumns: DataTableColumn<VacunaListItem>[] = [
    {
      key: "name",
      header: "Vacuna",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<VacunaListItem> = {
    key: "actions",
