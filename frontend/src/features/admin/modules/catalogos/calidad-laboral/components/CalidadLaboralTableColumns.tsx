...
interface BuildCalidadLaboralTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: CalidadLaboralListItem) => void;
  onToggleStatus: (item: CalidadLaboralListItem) => void;
  onRequestDelete: (item: CalidadLaboralListItem) => void;
}

export const buildCalidadLaboralTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildCalidadLaboralTableColumnsOptions): DataTableColumn<CalidadLaboralListItem>[] => {
  const baseColumns: DataTableColumn<CalidadLaboralListItem>[] = [
    {
      key: "id",
      header: "Codigo",
      accessorKey: "id",
  ...
  const actionColumn: DataTableColumn<CalidadLaboralListItem> = {
    key: "actions",
...
export const buildCalidadLaboralVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "id", label: "Codigo" },
    { key: "name", label: "Calidad laboral" },
