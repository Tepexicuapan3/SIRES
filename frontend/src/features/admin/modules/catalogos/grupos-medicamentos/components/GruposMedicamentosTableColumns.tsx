...
interface BuildGruposMedicamentosTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: GrupoMedicamentosListItem) => void;
  onToggleStatus: (item: GrupoMedicamentosListItem) => void;
  onRequestDelete: (item: GrupoMedicamentosListItem) => void;
}

export const buildGruposMedicamentosTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildGruposMedicamentosTableColumnsOptions): DataTableColumn<GrupoMedicamentosListItem>[] => {
  const baseColumns: DataTableColumn<GrupoMedicamentosListItem>[] = [
    {
      key: "name",
      header: "Grupo de medicamentos",
      accessorKey: "name",
      className: "w-[320px]",
  ...
  const actionColumn: DataTableColumn<GrupoMedicamentosListItem> = {
    key: "actions",
...
export const buildGruposMedicamentosVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Grupo de medicamentos" },
