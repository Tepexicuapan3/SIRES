...
interface BuildOrigenConsultaTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: OrigenConsultaListItem) => void;
  onToggleStatus: (item: OrigenConsultaListItem) => void;
  onRequestDelete: (item: OrigenConsultaListItem) => void;
}

export const buildOrigenConsultaTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildOrigenConsultaTableColumnsOptions): DataTableColumn<OrigenConsultaListItem>[] => {
  const baseColumns: DataTableColumn<OrigenConsultaListItem>[] = [
    {
      key: "id",
      header: "Codigo",
      accessorKey: "id",
  ...
  const actionColumn: DataTableColumn<OrigenConsultaListItem> = {
    key: "actions",
...
export const buildOrigenConsultaVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "id", label: "Codigo" },
    { key: "name", label: "Origen de consulta" },
