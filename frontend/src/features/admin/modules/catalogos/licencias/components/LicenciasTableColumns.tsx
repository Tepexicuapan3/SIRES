...
interface BuildLicenciasTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: LicenciaListItem) => void;
  onToggleStatus: (item: LicenciaListItem) => void;
  onRequestDelete: (item: LicenciaListItem) => void;
}

export const buildLicenciasTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildLicenciasTableColumnsOptions): DataTableColumn<LicenciaListItem>[] => {
  const baseColumns: DataTableColumn<LicenciaListItem>[] = [
    {
      key: "name",
      header: "Licencia",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<LicenciaListItem> = {
    key: "actions",
...
export const buildLicenciasVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Licencia" },
