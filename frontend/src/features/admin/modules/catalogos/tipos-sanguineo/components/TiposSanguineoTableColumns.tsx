...
interface BuildTiposSanguineoTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: TipoSanguineoListItem) => void;
  onToggleStatus: (item: TipoSanguineoListItem) => void;
  onRequestDelete: (item: TipoSanguineoListItem) => void;
}

export const buildTiposSanguineoTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildTiposSanguineoTableColumnsOptions): DataTableColumn<TipoSanguineoListItem>[] => {
  const baseColumns: DataTableColumn<TipoSanguineoListItem>[] = [
    {
      key: "name",
  ...
  const actionColumn: DataTableColumn<TipoSanguineoListItem> = {
    key: "actions",
...
export const buildTiposSanguineoVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Tipo sanguineo" },
