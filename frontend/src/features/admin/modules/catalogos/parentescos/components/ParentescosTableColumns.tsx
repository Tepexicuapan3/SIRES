...
interface BuildParentescosTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: ParentescoListItem) => void;
  onToggleStatus: (item: ParentescoListItem) => void;
  onRequestDelete: (item: ParentescoListItem) => void;
}

export const buildParentescosTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildParentescosTableColumnsOptions): DataTableColumn<ParentescoListItem>[] => {
  const baseColumns: DataTableColumn<ParentescoListItem>[] = [
    {
      key: "id",
      header: "Codigo",
      accessorKey: "id",
  ...
  const actionColumn: DataTableColumn<ParentescoListItem> = {
    key: "actions",
...
export const buildParentescosVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "id", label: "Codigo" },
    { key: "name", label: "Parentesco" },
