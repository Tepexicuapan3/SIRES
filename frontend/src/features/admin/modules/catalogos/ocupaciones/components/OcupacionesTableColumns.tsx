...
interface BuildOcupacionesTableColumnsOptions {
  canRead: boolean;
  canUpdate: boolean;
  canDelete: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: OcupacionListItem) => void;
  onToggleStatus: (item: OcupacionListItem) => void;
  onRequestDelete: (item: OcupacionListItem) => void;
}

export const buildOcupacionesTableColumns = ({
  canRead,
  canUpdate,
  canDelete,
  isStatusPending,
  ...
  onToggleStatus,
  onRequestDelete,
}: BuildOcupacionesTableColumnsOptions): DataTableColumn<OcupacionListItem>[] => {
  const baseColumns: DataTableColumn<OcupacionListItem>[] = [
    {
      key: "name",
      header: "Ocupacion",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<OcupacionListItem> = {
    key: "actions",
...
export const buildOcupacionesVisibilityOptions = (
  showActions: boolean,
): TableColumnVisibilityItem[] => {
  const options: TableColumnVisibilityItem[] = [
    { key: "name", label: "Ocupacion" },
