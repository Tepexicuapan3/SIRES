...
export default function ReservaExitosaPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-50 p-6">
      <div className="flex w-full max-w-md flex-col gap-6 rounded-lg border border-slate-200 bg-white p-6 text-center shadow-sm">
        ...
        <div className="flex flex-col gap-1 rounded-md bg-slate-50 p-4">
