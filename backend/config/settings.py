...
Base settings generated with `django-admin startproject` and adapted for SIRES.
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="sires_auth"),
        "USER": config("DB_USER", default="sires_auth"),
        "PASSWORD": config("DB_PASSWORD", default="sires_auth_dev_password"),
